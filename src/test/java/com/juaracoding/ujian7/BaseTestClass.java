...
import com.juaracoding.ujian7.pages.PemasukanPage;
import com.juaracoding.ujian7.pages.PengeluaranPage;
import com.juaracoding.ujian7.utils.Utils;
...
public class BaseTestClass {
	...
	ExtentTest logger;
	PengeluaranPage pengeluaranPage;
	PemasukanPage pemasukanPage;
	...
	public void beforeMethodTest() {
		pengeluaranPage = new PengeluaranPage(driver);
		pemasukanPage = new PemasukanPage(driver);
	}

	@AfterMethod
	public void getResult(ITestResult result) throws IOException {
		if (result.getStatus() == ITestResult.FAILURE) {
			String screenShotPath = Utils.screenShot(driver,
					result.getMethod().getDescription().replace(" ", "_").toLowerCase());
